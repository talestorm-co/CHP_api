...
Возвращает в **случае успеха**:
   Список всех возможных имён катировок 
...
Параметры:
 - symbols - имя или список катировок для подписки
   * list[str] - список нескольких катировок (Пример: ['SBER', 'GAZP'])
   * str - одна катировка для подписки (Пример: 'SBER')


Возвращает в **случае успеха**:
   словарь в формате {'symbol': 'ответ сервера на подписку на эту "quotes"'}
   > если в ответе на подписку на катировку в поле result было True, она добавлена в [listening_quotes](#listening_quotes)
   > если в ответе на подписку на катировку в поле result было False или поля result не было, она не добавлена в [listening_quotes](#listening_quotes)
...
Возвращает в **случае успеха**:
   Информацию по всем подписаным катировкам
...
Параметры:
 - symbols - пустое или имя/список катировок для подписки
   * пустое (не переданы параметры) - отправит запрос на отписку от всех катировак из [listening_quotes](#listening_quotes)
   * list[str] - список нескольких катировок (Пример: ['SBER', 'GAZP'])
   * str - одна катировка для подписки (Пример: 'SBER')
...
Возвращает в **случае успеха**:
   словарь в формате {'symbol': 'ответ сервера на подписку на эту "quotes"'}
   > если в ответе на подписку на катировку в поле result было True, она удалена из [listening_quotes](#listening_quotes)
